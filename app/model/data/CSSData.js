...
let supportData = JSON.parse(fs.readFileSync(path.normalize("../../db/CSS/support.json")));
let propertyData = JSON.parse(fs.readFileSync(path.normalize("../../db/CSS/properties.json")));
